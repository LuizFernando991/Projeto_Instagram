...
export function NavBar({ isCreatePostOpen, setIsCreatePostOpen }: NavBarProps): ReactElement {
    ...
    function handleOnNotificationClick() {
        setIsNotificationsOpen(true)
        setHaveNotifications(false)
        api.put('user/clearnotifications')
    }
    return (
        <Styled.NavBar>
            <Link href="/">
            ...
            <Styled.Notifications>
                <div onClick={handleOnNotificationClick}>
                    {isNotificationsOpen ? (
                        <div>
                            <svg
                        ...
                        <div>
                            ...
                            {haveNotifications ? <div className="notification-dot"></div> : ''}
                        </div>
                    )}
                </div>
